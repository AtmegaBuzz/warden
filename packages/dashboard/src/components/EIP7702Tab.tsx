  ...
  return (
    <div className="space-y-10">
      ...
      <section>
        ...
        <p className="text-sm text-slate-500 mb-6">
          Warden builds on a composable stack of 6 EIPs and ERCs.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {([
            ...
            },
            {
              ...
              detail: 'supportsInterface() for 7821, 7710, 165. Wallets auto-detect Warden capabilities.',
              status: 'implemented' as const, color: 'border-slate-300',
            },
            {
              icon: Frame, standard: 'EIP-8141', title: 'Frame Transactions',
              detail: 'Native AA via frame-based transactions. Warden policies become validation frames when Hegota fork lands H2 2026.',
