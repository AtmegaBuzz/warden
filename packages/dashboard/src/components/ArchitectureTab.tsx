...
const MCP_TOOLS = [
  ...
  'warden_grant_permissions', 'warden_revoke_permissions', 'warden_get_permissions',
] as const
...
const TECH_STACK = [
  ...
  { icon: Cpu, title: 'MCP Protocol', color: 'bg-purple-600',
    description: 'Model Context Protocol for AI agent tool calling. 14 callable tools. Any MCP-compatible agent can use Warden.' },
...
const COMPETITOR_FEATURES: { feature: string; warden: boolean; l1ad: boolean | null; policyLayer: boolean | null; litProtocol: boolean; crossmint: boolean }[] = [
  { feature: 'EIP-7702 delegation', warden: true, l1ad: false, policyLayer: false, litProtocol: false, crossmint: false },
  { feature: 'On-chain enforcement', warden: true, l1ad: false, policyLayer: false, litProtocol: false, crossmint: false },
  { feature: 'Off-chain policy engine', warden: true, l1ad: true, policyLayer: true, litProtocol: false, crossmint: false },
  { feature: '10 policy rules', warden: true, l1ad: true, policyLayer: null, litProtocol: false, crossmint: false },
  { feature: 'Risk scoring 0-100', warden: true, l1ad: false, policyLayer: false, litProtocol: false, crossmint: false },
  { feature: 'Anomaly detection', warden: true, l1ad: false, policyLayer: false, litProtocol: false, crossmint: false },
  { feature: 'ERC-8004 identity', warden: true, l1ad: false, policyLayer: false, litProtocol: false, crossmint: false },
  { feature: 'MCP server (14 tools)', warden: true, l1ad: false, policyLayer: false, litProtocol: false, crossmint: false },
  { feature: 'Real testnet transactions', warden: true, l1ad: false, policyLayer: null, litProtocol: false, crossmint: false },
  { feature: 'Session keys', warden: true, l1ad: false, policyLayer: null, litProtocol: false, crossmint: false },
  { feature: 'Emergency freeze', warden: true, l1ad: true, policyLayer: false, litProtocol: false, crossmint: false },
  { feature: 'Self-custodial (WDK)', warden: true, l1ad: true, policyLayer: false, litProtocol: true, crossmint: false },
  { feature: 'ERC-7710 delegation', warden: true, l1ad: false, policyLayer: false, litProtocol: false, crossmint: false },
  { feature: 'ERC-7715 permissions', warden: true, l1ad: false, policyLayer: false, litProtocol: false, crossmint: false },
]
  ...
  return (
    <div className="space-y-10">
      ...
      <section>
        ...
        <p className="text-sm text-slate-500 mb-4">The full EIP/ERC standards Warden implements — from permission request to on-chain execution.</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr>
                ...
                <th className="bg-orange-50 px-4 py-3.5 text-center font-bold text-orange-800 text-xs uppercase tracking-wider border-x border-orange-200">Warden</th>
              ...
              {COMPETITOR_FEATURES.map((row, i) => (
                <tr key={row.feature} className={i % 2 === 1 ? 'bg-slate-50/50' : ''}>
                  ...
                  <td className="px-4 py-3 text-center bg-orange-50/60 border-x border-orange-100">
                    <CompetitorCell value={row.warden} />
                  </td>
